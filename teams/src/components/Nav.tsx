  ...
  return (
    ...
    <div className="inline-flex items-center border-0  w-[100%] py-4 bg-cyan-500 ">
      ...
      <div className=" flex mx-auto items-left  w-[40%]">
        <img className="w-[8%] ml-[100px] cursor-pointer" src={School} alt="logo" /><h1 className="flex  "></h1>
      </div>
      ...
      <div className="w-[60%] flex justify-end list-none gap-10 m-[4]  cursor-pointer mr[10px]">
        ...
        <Link to={"/Missing"}><li className="text-white hover:text-blue-600">Missing Report</li></Link>
        <Link to={"/Contact_us"}><li className="text-white hover:text-blue-600">Contact</li></Link>
        <Link to={"/Grade"}><li className="text-white hover:text-blue-600">Help</li></Link>
