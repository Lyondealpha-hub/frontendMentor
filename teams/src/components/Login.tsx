...
const Login = () => {
  const input = [
    ...
    { id: 1, label: "Password :", indexId: "1", type: "password", placeholder: " Enter Password", labelStyle: "block text-base mb-2 mt-3 ", inputStyle: "mt-3 border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-500" },
